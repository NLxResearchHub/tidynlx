...
- __Synchronous API__: REST API for paging through data 50 records at a time.
- __Asynchronous API__: REST API for downloading large quantities of data from the NLx Research Hub (i.e. an entire month of jobs data from a single state or territory).
